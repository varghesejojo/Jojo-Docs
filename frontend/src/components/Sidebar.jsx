    ...
    >
      <div className="flex flex-col h-full">
        ...
        <nav className="mt-8 space-y-2">
          <SidebarItem icon={<FileText size={20} />} title="My Documents" active dark={dark} />
          <SidebarItem icon={<Clock3 size={20} />} title="Recent" dark={dark} />
          <SidebarItem icon={<Star size={20} />} title="Starred" dark={dark} />
          <SidebarItem icon={<Folder size={20} />} title="Folders" dark={dark} />
          <SidebarItem icon={<Trash2 size={20} />} title="Trash" dark={dark} />
        </nav>
        ...
        <div className="mt-auto">
          <div className="bg-linear-to-br from-blue-600 to-indigo-600 rounded-3xl p-5 text-white">
            ...
            <p className="text-xs mt-3 opacity-80">7.2 GB used of 10 GB</p>
          </div>
